...
&& wget --no-check-certificate https://github.com/rclone/rclone/releases/download/v1.58.1/rclone-v1.58.1-linux-${s6_arch}.zip \
&& unzip rclone-v1.58.1-linux-${s6_arch}.zip \
